...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tsod-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14844&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tsod-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tsod` can be installed with:

```
conda install tsod
```

It is possible to list all of the versions of `tsod` available on your platform with:
